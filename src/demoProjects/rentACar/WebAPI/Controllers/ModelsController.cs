...
namespace WebAPI.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        public async Task<ActionResult> GetListByDynamic([FromQuery] PageRequest pageRequest, [FromBody] Dynamic dynamic)//Dynamic->bir json obje olarak istendiği için Post olarak yazıldı.
        {
