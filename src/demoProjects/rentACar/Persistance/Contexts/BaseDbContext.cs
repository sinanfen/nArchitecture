    ...
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Brand>(a =>
            {
                ...
                a.HasMany(p => p.Models); //Brand'ın bir sürü Model'i var.
            });
            ...
            modelBuilder.Entity<Model>(a =>
            {
                ...
                a.HasOne(p => p.Brand); //Model'in bir tane Brand'i var.
            });

            Brand[] brandsEntitySeeds = { new(1, "BMW"), new(2, "Mercedes") };
            modelBuilder.Entity<Brand>().HasData(brandsEntitySeeds);

            Model[] modelEntitySeeds = { new(1, 1, "M4", 2000, ""), new(2, 2, "CLK 500", 2500, ""), new(3, 1, "M3", 1500, "") };
